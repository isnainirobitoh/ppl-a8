...
// Mengambil nomor rekening mitra dari tabel mitra berdasarkan id_mitra pada tabel produk
$query_mitra = "SELECT m.nomorrekening FROM mitraa m
                JOIN produk p ON p.id_mitra = m.id
                WHERE p.id = p.id";
$result_mitra = mysqli_query($conn, $query_mitra);
$row_mitra = mysqli_fetch_assoc($result_mitra);
$nomor_rekening_mitra = $row_mitra['nomorrekening'];
        ...
        <div>
            <form action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    echo "Harga yang Harus Dibayar: Rp$total_harga.000<br>";
                    echo "Nomor Rekening Mitra: $nomor_rekening_mitra<br>";
                    ?>
                    <br>
                    ...
                    <div class="form-grup">
                        ...
                        <div class="input">
                            <input type="file" name="uploadbukti" placeholder="Masukkan Upload Bukti Pembayaran" id="uploadbukti" required/>
                       </div>
                    </div>
